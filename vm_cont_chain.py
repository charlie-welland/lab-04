...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("welland/ping")
    client.message_callback_add("welland/ping", on_message_from_ipinfo)
...
def on_message_from_ipinfo(client, userdata, message):
   ...
   client.publish("welland/pong",f"{newNum}")
   time.sleep(1)
...
if __name__ == '__main__':
    ...
    #client.publish("welland/pong", count)
